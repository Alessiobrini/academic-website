...
\vspace{-1.5em}
\begin{list}{$\cdot$}{\leftmargin=0em}
\item "On Deep Reinforcement Learning for Dynamic Trading with PPO: Challenges and Future Directions" (with Petter Kolm), published in "The Journal of Financial Data Science".
...
\item "Pricing Cryptocurrency Options with Machine Learning Regression for Handling Market Volatility" (with Jimmie Lenz), published in "Economic Modelling".
\item "A Comparison of Cryptocurrency Volatility-benchmarking New and Mature Asset Classes" (with Jimmie Lenz), published in "Financial Innovation".
...
\vspace{-1.5em}
\begin{list}{$\cdot$}{\leftmargin=0em}
\item "StableAML: Machine Learning for Behavioral Wallet Detection in Stablecoin Anti-Money Laundering on Ethereum" (with Luciano Juvinski and Haochen Li), arXiv:2602.17842 (2026).
\item "A Nonlinear Target-Factor Model with Attention Mechanism for Mixed-Frequency Data" (with Ekaterina Seregina), arXiv:2601.16274 (2026).
\item "Empirical Models of the Time Evolution of SPX Option Prices" (with David Hsieh, Patrick Kuiper, Sean Moushegian, and David Ye), arXiv:2506.17511 (2025).
